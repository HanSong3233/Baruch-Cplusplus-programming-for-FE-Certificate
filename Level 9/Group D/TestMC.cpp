...
//enter the Batch 1 to Batch 4 for convinence
namespace Batch1
...
namespace Batch
{
	double T = 1.25; double K = 155; double sig = 0.25; double r = 0.03; double S = 150;
};
...
{
	return (SD(M,r,T)/ sqrt(M.size()));
}
int main()
{
    //using namespace Batch1;	//result: call:2,13337, put: 5.84628
	using namespace Batch; //result: call:7.96557, put:7.96557
	...
	double STDEV=SD(result,myOption.r,myOption.T);
	double STERR=SE(result,myOption.r,myOption.T);
