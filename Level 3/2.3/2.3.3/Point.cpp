...
double Point::X()  //set the value of point in X coordinates
{
	return m_x;
}

double Point::Y()  ////get the value of point in X coordinates
{
	return m_y;
}
...
double Point::Distance()//return the distance of point to the origin 
{
