...
public:
	...
	//Modifier
	void X(double new_X) {m_x = new_X;};//set the value of X,using default inline function. 
	void Y(double new_Y) {m_y = new_Y;}; //set the value of Y,using default inline function. 

};
//using normal inline function to get the value of X.  
