...
Line::Line(): Start_point(0,0),End_point(0,0) //default constructor
{
...
{
	//cout << "line destruction finished" << endl;
}

Line::Line(const Point& p1, const Point& p2): Start_point(p1),End_point(p2) //constructor
{
	/*Start_point = p1;
	End_point = p2;*/
...
Line::Line(const Line& l):Start_point(l.Start_point),End_point(l.End_point)//copy constructor
{
