...
Circle::Circle(): m_radius(0),Centre_point(0,0)	 // Default constructor
{
...
Circle::Circle(const Circle& c)	: m_radius(c.m_radius), Centre_point(c.Centre_point)//Copy constructor
{
	//m_radius = c.m_radius;
