...
template <class T>
Array<T>::Array() : m_size(1), m_data(new T[1]) {cout << "Array created." << endl;}	 // Default constructor

// constructor with the size of array given
template <class T>
Array<T>::Array(const int& size_of_array) : m_size(size_of_array), m_data(new T[size_of_array]) { cout << "Array created." << endl; }
