...
private:
	...
	static int default_size;   //add an static variable indicating the default size.
...
public:
	...
	static int GetDefaultSize();                 //a static function to set and get the default size. 
	// Setter functions
	static void DefaultSize(int a); // Set the default size of the array
